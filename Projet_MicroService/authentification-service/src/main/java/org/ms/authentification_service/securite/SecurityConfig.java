package org.ms.authentification_service.securite; 
 
import org.ms.authentification_service.entities.AppUser;
import org.ms.authentification_service.filtres.JwtAuthenticationFilter;
import org.ms.authentification_service.filtres.JwtAuthorizationFilter;
...
appUser.getPassword(),permissions); 
           } 
       }); 
    } 
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception  
      ...
      http.csrf().disable(); //désactiver la protection contre CSRF 
         ...
         //http.formLogin(); 
         http.authorizeRequests().requestMatchers("/refreshToken/**").permitAll();
