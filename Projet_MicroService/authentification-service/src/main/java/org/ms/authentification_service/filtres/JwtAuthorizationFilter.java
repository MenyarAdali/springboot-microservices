package org.ms.authentification_service.filtres;
...
public class JwtAuthorizationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
        ...
        // Cas 1 : le header contient un token JWT valide
        if (authorizationToken != null && authorizationToken.startsWith(PREFIXE_JWT)) {
            try {
                ...
                return; // Très important : éviter de continuer si JWT invalide
            }
        }

        // Cas 2 : pas de token valide ou path = /refreshToken → continuer sans authentification
